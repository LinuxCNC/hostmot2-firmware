...
proc import { {working_area ""} {staging_area ""} { srcctrl_comp 0 } } {
  ...
  HandleException {
   ...
   set opts_stream [ [Xilinx::Cit::FactoryCreate $::xilinx::Dpm::StreamBufferCompID ]  GetInterface $xilinx::Prjrep::IStreamID ] 
     ...
     $opts_stream WriteString "C:/ISE9/5i22/hostmot2/Top9030HostMot2.vhd"
     $opts_stream WriteString "22"
     $opts_stream WriteString "./xst"
     $opts_stream WriteString "C:/ISE9/5i22/hostmot2/b32test_guide.ncd"
     $opts_stream WriteString "C:/ISE9/5i22/hostmot2/Big32_guide.ncd"
     ...
     $opts_stream WriteString "C:/ISE9/5i22/hostmot2/threephasepwm_guide.ncd"
     ...
     $opts_stream WriteString "C:/ISE9/5i22/hostmot2/TopUSBHostMot2_guide.ncd"
